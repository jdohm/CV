...
%\setkomavar{fromlogo}{
  %\parbox[b]{7cm}{\usekomafont{fromaddress}%
 %{\mbox{\includegraphics[
  %width=15cm,
  %height=5cm,
  %keepaspectratio]{073-020-Dohm-038_small.jpg}}}
 %%       {\mbox{\LARGE \bfseries Jannis Dohm}}
         %\smallskip
   %}
 %}
 \setkomavar{fromlogo}{\tikz[overlay,remember picture]
      \node [anchor = north east, inner sep = .92cm, xshift=-.45cm]
            at (current page.north east)
            {\includegraphics[height=5cm]{073-020-Dohm-038_small.jpg}};}
...
\begin{letter}{Test Name\\ Test Street 123\\444xx Wuppertal}
    %\input{background/page1/background1.tex}
    %\input{background/pageMe/backgroundMe.tex}
    %\input{background/pageThis/backgroundThis.tex}
    \input{background/pageNerd/backgroundNerd.tex}
